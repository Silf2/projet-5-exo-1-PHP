...
class Command{
    ...
    public function list(){                                                         //Méthode permettant l'affichage de la liste des contacts
    ...
    public function detail($idDetail){                                              //Méthode permettant l'affichage d'un seul contact
    ...
    public function create($newName, $newEmail, $newPhone){                         //Méthode permettant de créer un nouveau contact en lui spécifiant un nom, un email et un numéro de tel
    ...
    public function delete($idDelete){                                              //Méthode permettant de supprimer un contact en indiquant son ID
    ...
    public function help(){                                                         //Méthode affichant l'aide
    ...
    public function exit(){                                                         //Méthode permettant de quitter le programme
        die('So long !');
    }

    public function error(){                                                        //Méthode à appeler en cas d'erreur
